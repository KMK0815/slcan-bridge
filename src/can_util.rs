...
//! Copied from:
//! https://github.com/embassy-rs/embassy/blob/main/embassy-stm32/src/can/util.rs
//! embassy project is under APACHE and MIT-2.0 licenses
...
/// Calculate nominal CAN bit timing based on CAN bitrate and peripheral clock frequency
pub fn calc_can_timings(periph_clock: u32, can_bitrate: u32) -> Option<NominalBitTiming> {
    const BS1_MAX: u8 = 16;
    const BS2_MAX: u8 = 8;
